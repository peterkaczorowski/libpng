...
#define _png_XYZ_from_xy wx__png_XYZ_from_xy
#define _png_XYZ_normalize wx__png_XYZ_normalize
#define _png_build_16to8_table wx__png_build_16to8_table
#define _png_build_8bit_table wx__png_build_8bit_table
#define _png_colormap_compose wx__png_colormap_compose
#define _png_colorspace_check_XYZ wx__png_colorspace_check_XYZ
#define _png_colorspace_check_gamma wx__png_colorspace_check_gamma
#define _png_colorspace_set_xy_and_XYZ wx__png_colorspace_set_xy_and_XYZ
#define _png_compare_ICC_profile_with_sRGB wx__png_compare_ICC_profile_with_sRGB
#define _png_default_warning wx__png_default_warning
#define _png_do_chop wx__png_do_chop
#define _png_do_compose wx__png_do_compose
#define _png_do_encode_alpha wx__png_do_encode_alpha
#define _png_do_expand_16 wx__png_do_expand_16
#define _png_do_expand_palette wx__png_do_expand_palette
#define _png_do_gamma wx__png_do_gamma
#define _png_do_pack wx__png_do_pack
#define _png_do_quantize wx__png_do_quantize
#define _png_do_read_filler wx__png_do_read_filler
#define _png_do_read_intrapixel wx__png_do_read_intrapixel
#define _png_do_read_invert_alpha wx__png_do_read_invert_alpha
#define _png_do_read_swap_alpha wx__png_do_read_swap_alpha
#define _png_do_rgb_to_gray wx__png_do_rgb_to_gray
#define _png_do_scale_16_to_8 wx__png_do_scale_16_to_8
#define _png_do_shift wx__png_do_shift
#define _png_do_unpack wx__png_do_unpack
#define _png_do_unshift wx__png_do_unshift
#define _png_do_write_intrapixel wx__png_do_write_intrapixel
#define _png_do_write_invert_alpha wx__png_do_write_invert_alpha
#define _png_do_write_swap_alpha wx__png_do_write_swap_alpha
#define _png_fixed_inches_from_microns wx__png_fixed_inches_from_microns
#define _png_fp_add wx__png_fp_add
#define _png_fp_sub wx__png_fp_sub
#define _png_gamma_not_sRGB wx__png_gamma_not_sRGB
#define _png_gamma_threshold wx__png_gamma_threshold
#define _png_get_fixed_point wx__png_get_fixed_point
#define _png_icc_tag_char wx__png_icc_tag_char
#define _png_icc_tag_name wx__png_icc_tag_name
#define _png_image_format wx__png_image_format
#define _png_image_free_function wx__png_image_free_function
#define _png_image_set_PLTE wx__png_image_set_PLTE
#define _png_inflate_read wx__png_inflate_read
#define _png_init_filter_functions wx__png_init_filter_functions
#define _png_init_palette_transformations wx__png_init_palette_transformations
#define _png_init_rgb_transformations wx__png_init_rgb_transformations
#define _png_pow10 wx__png_pow10
#define _png_product2 wx__png_product2
#define _png_read_buffer wx__png_read_buffer
#define _png_read_destroy wx__png_read_destroy
#define _png_rtran_ok wx__png_rtran_ok
#define _png_safe_add wx__png_safe_add
#define _png_setup_avg_row wx__png_setup_avg_row
#define _png_setup_avg_row_only wx__png_setup_avg_row_only
#define _png_setup_paeth_row wx__png_setup_paeth_row
#define _png_setup_paeth_row_only wx__png_setup_paeth_row_only
#define _png_setup_sub_row wx__png_setup_sub_row
#define _png_setup_sub_row_only wx__png_setup_sub_row_only
#define _png_setup_up_row wx__png_setup_up_row
#define _png_setup_up_row_only wx__png_setup_up_row_only
#define _png_text_compress_init wx__png_text_compress_init
#define _png_unpremultiply wx__png_unpremultiply
#define _png_write_chunk_header wx__png_write_chunk_header
#define _png_write_complete_chunk wx__png_write_complete_chunk
#define _png_write_compressed_data_out wx__png_write_compressed_data_out
#define _png_write_destroy wx__png_write_destroy
#define _png_write_filtered_row wx__png_write_filtered_row
